      ...
      do j = 1, Properties%Elements(i)%Number_of_Sides
        ...
        if (Properties%Elements(i)%Sides(j)%Nodes_on_Side == 4) then
          ...
          if (EEList_1(i,j) /= 0) then
            ...
            if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),1) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),1) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),1) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,4),1) == 0.0_8) then
              Properties%Elements(i)%Neighbours(j,2) = 1
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),1) == Properties%Length(1) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),1) == Properties%Length(1) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),1) == Properties%Length(1) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,4),1) == Properties%Length(1)) then
              Properties%Elements(i)%Neighbours(j,2) = 2
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),2) == Properties%Length(2) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),2) == Properties%Length(2) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),2) == Properties%Length(2) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,4),2) == Properties%Length(2)) then
              Properties%Elements(i)%Neighbours(j,2) = 3
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),2) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),2) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),2) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,4),2) == 0.0_8) then
              Properties%Elements(i)%Neighbours(j,2) = 4
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),3) == Properties%Length(3) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),3) == Properties%Length(3) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),3) == Properties%Length(3) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,4),3) == Properties%Length(3)) then
              Properties%Elements(i)%Neighbours(j,2) = 5
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),3) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),3) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),3) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,4),3) == 0.0_8) then
          ...
          if (EEList_1(i,j) /= 0) then
            ...
            if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),1) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),1) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),1) == 0.0_8) then
              Properties%Elements(i)%Neighbours(j,2) = 1
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),1) == Properties%Length(1) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),1) == Properties%Length(1) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),1) == Properties%Length(1)) then
              Properties%Elements(i)%Neighbours(j,2) = 2
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),2) == Properties%Length(2) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),2) == Properties%Length(2) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),2) == Properties%Length(2)) then
              Properties%Elements(i)%Neighbours(j,2) = 3
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),2) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),2) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),2) == 0.0_8) then
              Properties%Elements(i)%Neighbours(j,2) = 4
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),3) == Properties%Length(3) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),3) == Properties%Length(3) .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),3) == Properties%Length(3)) then
              Properties%Elements(i)%Neighbours(j,2) = 5
            else if (Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,1),3) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,2),3) == 0.0_8 .and. Properties%Elements(i)%Coordinates(Properties%Elements(i)%Side_Nodes(j,3),3) == 0.0_8) then
              Properties%Elements(i)%Neighbours(j,2) = 6
            end if
